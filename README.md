...
# Project List (develop branch)
1. [Textual Entailment](https://github.com/saaltech/saal-datascience-textual-entailment/tree/develop)
1. [Article Extraction](https://github.com/saaltech/saal-datascience-article-extraction/tree/develop)
1. [Sentiment Analysis](https://github.com/saaltech/saal-sentiment-analysis/tree/develop)
